          ...
          <div className="w-full bg-center bg-cover h-[612px] bg-[#0465f8]">
            <div className="flex items-center justify-center w-full h-full bg-gray-900/40">
              <div className="text-center">
                ...
                <button className=" px-7 py-2 w-[148.83px]  h-[47px] mt-8 text-sm font-medium text-[#0465f8] capitalize transition-colors duration-300 transform bg-white rounded-none lg:w-auto  focus:outline-none hover:scale-110 ">
                  Read more
                </button>
              </div>
            </div>
